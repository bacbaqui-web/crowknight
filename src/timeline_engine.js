import { createControllerTimelineRenderer } from './timeline_view.js';
import {
  createTimelineClipboardControls,
  createTimelinePlaybackControls,
  createTimelineSelectionControls,
} from './timeline_control_helper.js';
import {
...
export function createTimelineControllerCore({
  ...
  const clipboardControls = createTimelineClipboardControls({
  ...
  return {
    ...
    copyFrame: clipboardControls.copyFrame,
    currentFrameValue,
    deleteKeyframe,
