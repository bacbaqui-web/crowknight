...
import { isPartWithAnchor, isPartWithOpacity, isPartWithSize } from './part_source_data.js';
...
export function groupActionPropertyGroups() {
  return editableTransformPropertyGroups({
...
export function actionPropertyGroups(partKey, hasFrameSelection) {
  ...
  return editableTransformPropertyGroups({
    ...
    sizeLabel: actionSizeGroupLabel(partKey),
