...
export const TUNING_FIELDS = [
  ...
  ['jumpHoldMax', ['jumpHoldMax']],
  ['jumpHoldForce', ['jumpHoldForce']],
  ...
  ['idleAnimationIntensity', ['motion', 'animationIntensity', 'idle']],
  ['runAnimationIntensity', ['motion', 'animationIntensity', 'run']],
  ['jumpAnimationIntensity', ['motion', 'animationIntensity', 'jump']],
  ['fallAnimationIntensity', ['motion', 'animationIntensity', 'fall']],
  ['glideAnimationIntensity', ['motion', 'animationIntensity', 'glide']],
  ['rollAnimationIntensity', ['motion', 'animationIntensity', 'roll']],
  ['guardAnimationIntensity', ['motion', 'animationIntensity', 'guard']],
  ['guardBreakAnimationIntensity', ['motion', 'animationIntensity', 'guardBreak']],
  ['hurtAnimationIntensity', ['motion', 'animationIntensity', 'hurt']],
  ['deathAnimationIntensity', ['motion', 'animationIntensity', 'death']],
  ['jumpAttackAnimationIntensity', ['motion', 'animationIntensity', 'jumpAttack']],
  ['attack1AnimationIntensity', ['motion', 'animationIntensity', 'attack1']],
  ['attack2AnimationIntensity', ['motion', 'animationIntensity', 'attack2']],
  ['attack3AnimationIntensity', ['motion', 'animationIntensity', 'attack3']],
  ['walkSpeed', ['motion', 'walkSpeed']],
  ['walkBob', ['motion', 'walkBob']],
  ['walkBody', ['motion', 'walkBody']],
  ['walkArmSwing', ['motion', 'walkArmSwing']],
  ['walkLegSwing', ['motion', 'walkLegSwing']],
  ['jumpRiseGravity', ['motion', 'jumpRiseGravity']],
  ['jumpRiseEase', ['motion', 'jumpRiseEase']],
  ['dashLean', ['motion', 'dashLean']],
  ['rollSpin', ['motion', 'rollSpin']],
  ['rollTuck', ['motion', 'rollTuck']],
  ['rollLift', ['motion', 'rollLift']],
];
