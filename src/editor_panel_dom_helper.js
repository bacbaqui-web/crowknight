...
export function getTuningPanelElements(panel) {
  ...
  return {
    ...
    difficultyBossKillInterval: document.querySelector('#difficultyBossKillInterval'),
    difficultyBossHpPerLevel: document.querySelector('#difficultyBossHpPerLevel'),
    difficultySwordmanSpawnPerLevel: document.querySelector('#difficultySwordmanSpawnPerLevel'),
    difficultyArcherSpawnPerLevel: document.querySelector('#difficultyArcherSpawnPerLevel'),
    difficultyWarningText: document.querySelector('#difficultyWarningText'),
